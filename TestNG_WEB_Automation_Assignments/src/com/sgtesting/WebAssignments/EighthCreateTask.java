...
public class EighthCreateTask {
	...
	public static void CreateTask(String task)
	{
		try
		{
			...
			Thread.sleep(3000);	
			WebElement oLink=oBrowser.findElement(By.xpath("//*[@id='createTasksPopup_commitBtn']"));
			Assert.assertFalse(oLink.isDisplayed());
	...
	public static void DeleteTask()
	{
		try
		{
			...
			Thread.sleep(3000);
			WebElement oLink=oBrowser.findElement(By.xpath("//*[@id='deleteTaskPopup_deleteConfirm_submitBtn']"));
			Assert.assertFalse(oLink.isDisplayed());
	...
	public Object[] getCreateTaskData()
	{
